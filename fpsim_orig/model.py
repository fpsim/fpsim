...
class Person(base.ParsObj):
    ...
    def check_conception(self):
        ...
        self.step_results['preg_probs'] = preg_prob
        if pregnant:
            self.step_results['preg_inds'] = self.uid
    ...
    def update(self, t, y):
        ...
        self.step_results['preg_probs'] = None
        self.step_results['preg_inds'] = None
    ...
    def run(self, verbose=None):
        ...
        for i in range(self.npts):  # Range over number of timesteps in simulation (ie, 0 to 261 steps)
            ...
            for person in self.people.values():
                ...
                if step_results['preg_inds'] is not None:
