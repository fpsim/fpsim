...
if do_save:
    ...
    deliveries.to_csv('/Users/Annie/model_postprocess_files/deliveries_'+{ppl.uid[agent]}+'.csv')
    stillbirths.to_csv('/Users/Annie/model_postprocess_files/stillbirths_'+{ppl.uid[agent]}+'.csv')
