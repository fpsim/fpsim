...
# existing contraceptive to abort.
...
# !!! Is 90 pills the size of a typical prescription, or from the DHS data we have?
    con_pill       = Contraceptive( Intervention_Name = "Pill",
                                    ...
                                    Usage_Duration_Distribution = Contraceptive_Usage_Duration_Distribution_Enum.UNIFORM_DISTRIBUTION, # CONSTANT_DISTRIBUTION does not work?
                                    #Usage_Duration_Constant = 90,
                                    Usage_Duration_Min = 89,
                                    Usage_Duration_Max = 90,
