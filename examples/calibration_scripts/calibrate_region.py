...
if __name__ == '__main__':
        ...
        figs_dir = os.path.join(cwd, country_dir, 'data/figs', region)
        ...
        data_asfr = pd.read_csv(f'{country_dir}/data/asfr_region.csv').loc[lambda df: df['region'] == formatted_region]
        data_methods = pd.read_csv(f'{country_dir}/data/mix_region.csv').loc[lambda df: (df['region'] == formatted_region) & (df['year'] == pars['end_year'])]
        data_tfr = pd.read_csv(f'{country_dir}/data/tfr_region.csv').loc[lambda df: df['region'] == formatted_region]
        data_use = pd.read_csv(f'{country_dir}/data/use_region.csv').loc[lambda df: (df['region'] == formatted_region) & (df['year'] == pars['end_year'])]
