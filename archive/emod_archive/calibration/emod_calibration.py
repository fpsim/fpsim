...
emod_path         = os.path.abspath('assets/Eradication')
...
#            S.campaign = make_campaign(use_contraception)
    ...
    results = exp.run(how='parallel', emod_path=emod_path, verbose=False)
...
#    pl.title('Calibration of Senegal demographics', fontweight='bold')
    ...
    if save_fig:
        fig.savefig('senegal_popsize_calibration.png', bbox_inches='tight', dpi=150)
