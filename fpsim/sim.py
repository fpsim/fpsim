...
class People(fpb.BasePeople):
    ...
    def __init__(self, pars, n=None, **kwargs):
        ...
        d = sc.mergedicts(fpp.person_defaults, kwargs) # d = defaults
        if n is None:
    ...
    def update_method(self):
        ...
        for key in fpp.method_age_map.keys():
        ...
        for key,(age_low, age_high) in fpp.method_age_map.items():
    ...
    def update_methods(self):
        ...
        if not (self.i % self.pars['method_timestep']): # Allow skipping timesteps
            ...
            whole_years = ((age_diff < (1/fpp.mpy)) * (age_diff > 0))
    ...
    def update_postpartum(self):
        ...
        for key,(pp_low, pp_high) in fpp.postpartum_map.items():
    ...
    def check_delivery(self):
        ...
        live_age = live.age
        for key, (age_low, age_high) in fpp.age_bin_map.items():
    ...
    def update_age(self):
        ...
        self.age += self.pars['timestep'] / fpp.mpy  # Age the person for the next timestep
    ...
    def init_step_results(self):
        ...
        for key in fpp.age_bin_map.keys():
...
class Sim(fpb.BaseSim):
    ...
    def run(self, verbose=None):
        ...
        for i in range(self.npts):  # Range over number of timesteps in simulation (ie, 0 to 261 steps)
            ...
            for agekey in fpp.age_bin_map.keys():
            ...
            if i % fpp.mpy == 0:
                ...
                start_index = (int(self.t)-1)*fpp.mpy
                stop_index = int(self.t)*fpp.mpy
    ...
    def plot(self, do_save=None, do_show=True, fig_args=None, plot_args=None, axis_args=None, fill_args=None,
        ...
        for p,title,keylabels in to_plot.enumitems():
            ...
            # Handle annotations
            fpu.fixaxis(useSI=fpp.useSI, set_lim=new_fig) # If it's not a new fig, don't set the lim
            if key == 'mcpr_by_year':
