"""
This configuration file is for an FPsim model specific to Niger.
...
def exposure_age():
    ...
    exposure_correction_age = np.array([[0,    5,  10, 12.5, 15, 18, 20, 25,  30,  35, 40, 45, 50],
                                        [0.5, 0.5, 0.5, 0.6, 0.6, 0.9,  0.9,  1,  0.8,0.4,0.4,0.4,0.3]])  # <<< USER-EDITABLE: Can be modified for calibration
...
def make_pars(location='niger', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
