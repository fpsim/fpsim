...
7. In your analysis repository, you can now use your custom location by adding the following to the imports at the top of a script: `from locations import <name>`.
