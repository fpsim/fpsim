...
# Settings
#country = 'nigeria_kaduna' # <<< USER-EDITABLE 
...
def make_pars(country):
    ...
    pars['fecundity_var_low'] = 0.01 # <<< USER-EDITABLE: Adjust/override any parameters that are defined in fpsim/defaults.py   
    pars['fecundity_var_high'] = 1.5 # <<< USER-EDITABLE: Adjust/override any parameters that are defined in fpsim/defaults.py   
