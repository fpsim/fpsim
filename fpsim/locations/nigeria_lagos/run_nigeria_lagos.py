...
def make_pars():
    ...
    cm_pars = dict(prob_use_year = 2020,  # Base year
                   ...
                   prob_use_intercept = -4,  # Intercept for the probability of using contraception - shifts the mCPR level
                   method_weights = np.array([1, 1, 3, 0.1, 1, 0.1, 2.5, 1, 1]))
