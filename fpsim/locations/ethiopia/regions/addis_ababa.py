"""
This configuration file is for an FPsim model specific to Ethiopia - Addis Ababa.
...
def make_pars(location='addis_ababa', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
