"""
This configuration file is for an FPsim model specific to Ethiopia - Oromia.
...
def make_pars(location='oromia', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
