"""
This configuration file is for an FPsim model specific to Ethiopia - Benishangul-Gumuz.
...
def make_pars(location='benishangul_gumuz', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
