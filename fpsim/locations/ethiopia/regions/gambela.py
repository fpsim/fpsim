"""
This configuration file is for an FPsim model specific to Ethiopia - Gambela.
...
def make_pars(location='gambela', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
