"""
This configuration file is for an FPsim model specific to Ethiopia - Somali.
...
def make_pars(location='somali', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
