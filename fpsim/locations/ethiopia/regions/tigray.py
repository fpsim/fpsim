"""
This configuration file is for an FPsim model specific to Ethiopia - Tigray.
...
def make_pars(location='tigray', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
