"""
This configuration file is for an FPsim model specific to Ethiopia - Harari.
...
def make_pars(location='harari', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
