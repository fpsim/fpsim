"""
This configuration file is for an FPsim model specific to Ethiopia - Sidama.
...
def make_pars(location='sidama', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
