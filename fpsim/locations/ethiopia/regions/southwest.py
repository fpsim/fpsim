"""
This configuration file is for an FPsim model specific to Ethiopia - South West Ethiopia Peoples' Region.
...
def make_pars(location='southwest', seed=None):  # <<< USER-EDITABLE: Change name of location; country name if country, region name if region
    """
