"""
Script to create a calibrated model of Nigeria Kano subregion.
...
def make_pars():
    ...
    pars['prob_use_trend_par'] = 0.07  # Time trend in contraceptive use - adjust this to get steeper/slower trend
    pars['prob_use_intercept'] = 1.11  # Intercept for the probability of using contraception - shifts the mCPR level
    pars['method_weights'] = np.array([0.2, 0.5, 6, 2, 0.7, 0.2, 1, 0.5, 1])
    ...
    pars['spacing_pref']['preference'][8:16] = 4  # Spacing of 24-48 months, e.g. 4x probabliity of sex
