...
class ContraceptiveChoice:
    ...
    def get_prob_use(self, ppl, year=None, event=None, ti=None, tperyear=None):
    ...
    def get_contra_users(self, ppl, year=None, event=None, ti=None, tperyear=None):
        """ Select contraception users, return boolean array """
        prob_use = self.get_prob_use(ppl, event=event, year=year, ti=ti, tperyear=tperyear)
...
class EmpoweredChoice(ContraceptiveChoice):
    ...
    def get_prob_use(self, ppl, year=None, inds=None, event=None, ti=None, tperyear=None):
        """
