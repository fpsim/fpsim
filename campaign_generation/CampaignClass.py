...
class CalendarEventCoordinator(BaseCampaign):
    _definition = {
        ...
        'Target_Demographic': {
            ...
            'enum': ['Everyone', 'ExplicitAgeRanges', 'ExplicitAgeRangesAndGender', 'ExplicitGender', 'PossibleMothers', 'ArrivingAirTravellers', 'DepartingAirTravellers', 'ArrivingRoadTravellers', 'DepartingRoadTravellers', 'AllArrivingTravellers', 'AllDepartingTravellers', 'ExplicitDiseaseState'],
            'type': 'enum',
        },
        'Target_Gender': {
            'default': 'All',
...
class NChooserEventCoordinator(BaseCampaign):
    _definition = {
        'Distributions': {
            ...
            'type': 'Vector TargetedDistribution',
        },
        'Intervention_Config': {
            'description': 'The nested JSON of the actual intervention to be distributed by this event coordinator.',
            'type': 'idmAbstractType:Intervention',
...
class NChooserEventCoordinatorHIV(BaseCampaign):
    _definition = {
        'Distributions': {
            ...
            'type': 'Vector TargetedDistributionHIV',
        },
        'Intervention_Config': {
            'description': 'The nested JSON of the actual intervention to be distributed by this event coordinator.',
            'type': 'idmAbstractType:Intervention',
...
class NChooserEventCoordinatorSTI(BaseCampaign):
    _definition = {
        'Distributions': {
            ...
            'type': 'Vector TargetedDistributionSTI',
        },
        'Intervention_Config': {
            'description': 'The nested JSON of the actual intervention to be distributed by this event coordinator.',
            'type': 'idmAbstractType:Intervention',
...
class LarvalHabitatMultiplier(BaseCampaign):
    _definition = {
        'LarvalHabitatMultiplier': {
            ...
            'type': 'Vector LarvalHabitatMultiplierSpec',
        },
